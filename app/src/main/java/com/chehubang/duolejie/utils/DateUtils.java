...
public class DateUtils {
    public static final String dateFormater_ch_YYMMDD_HHMM = "yyyy/MM/dd HH:mm";
...
//            pastDaysList.add(getPastDate(i));
     ...
     * @return
             */
    public static String TimeStamp2Date04(long milliseconds) {
        String date = Milliseconds2Date(milliseconds, dateFormater_ch_YYMMDD_HHMM);
        return date;
    }
    /**
     * 按格式输出时间串
