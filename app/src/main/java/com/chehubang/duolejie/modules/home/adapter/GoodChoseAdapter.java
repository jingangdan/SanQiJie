...
public class GoodChoseAdapter extends BaseAdapter {

    private List<GoodChoseBean> mList;
    private Context mcontext;

    public GoodChoseAdapter(Context context, List<GoodChoseBean> list) {
        mcontext = context;
        mList = list;
    }
    @Override
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        viewHolder.tv_content_text.setText(mList.get(position).getGoods_service());
