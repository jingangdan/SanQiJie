...
public class RechargeActivity extends BaseActivity<RechargePresenter> implements MainView {
    ...
    @BindView(R.id.tv_jcount)
    TextView tv_jcount;//所得劵数量

    @BindView(R.id.tv_jservice)
    TextView tv_Service;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_Service.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("url", "http://39.107.14.118/appInterface/aboutUsContentInfo.jhtml?id=16");
        ...
        tv_money.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                tv_jcount.setText("充值成功可获赠"+money / 5+"张免单券");
            }
        });
