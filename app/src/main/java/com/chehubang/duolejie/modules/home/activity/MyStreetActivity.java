    ...
    private void initDialog(final int position, final String num) {
        ...
        if (TextUtils.isEmpty(user_lettory)) {
            ...
            if (TextUtils.isEmpty(UserInfo.getInstance().getId())) {
                ...
                Dialog dialog1 = DialogUtils.getShowMsg(this, "免单券余额不足", this.getResources().getString(R.string.msg_shao_gift));
                dialog1.show();
            }
        } else {
        ...
        if (action == ACTION_DEFAULT + 1) {
            ...
            if (model != null) {
                ...
                if (TextUtils.equals(Constant.request_success, data.getStatus())) {
                    ...
                    if (mDialog == null) {
                        mDialog = DialogUtils.getShowMsg(this, "免单参与成功", getResources().getString(R.string.msg_gift));
                    }
                    mDialog.show();
                } else {
