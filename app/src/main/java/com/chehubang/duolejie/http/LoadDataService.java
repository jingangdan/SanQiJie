...
public interface LoadDataService {
    ...
    //获取开通会员价格接口
    @FormUrlEncoded
    @POST("appInterface/getPulsMoneyList.jhtml")
    Observable<ResponseBody> getPulsMoneyList(@FieldMap Map<String, String> data);
    ...
    //查询账单
    @FormUrlEncoded
    @POST("appInterface/getMoreDetailList.jhtml")
    Observable<ResponseBody> getMoreDetailList(@FieldMap Map<String, String> data);
...
//    Observable<ResponseBody> getBrandMsg(@FieldMap Map<String, String> data);
     ...
     */
    @FormUrlEncoded
    @POST("appInterface/getPaySuccessResultList.jhtml")
    Observable<ResponseBody> getBrandMsg(@FieldMap Map<String, String> data);
     ...
     */
    @FormUrlEncoded
    @POST("appInterface/recommender.jhtml")
    Observable<ResponseBody> recommender(@FieldMap Map<String, String> data);
     ...
     */
    @FormUrlEncoded
    @POST("appInterface/getUserMoneyData.jhtml")
    Observable<ResponseBody> getUserMoneyData(@FieldMap Map<String, String> data);
     ...
     */
    @FormUrlEncoded
    @POST("appInterface/getExchangeData.jhtml")
    Observable<ResponseBody> getExchangeData(@FieldMap Map<String, String> data);
     ...
     */
    @FormUrlEncoded
    @POST("appInterface/getAlreadyExchangeData.jhtml")
    Observable<ResponseBody> getAlreadyExchangeData(@FieldMap Map<String, String> data);

    @FormUrlEncoded
    @POST("appInterface/getRecommendList.jhtml")
    Observable<ResponseBody> getRecommendListData(@FieldMap Map<String, String> data);
     ...
     */
    @FormUrlEncoded
    @POST("appInterface/isDisplayLineBrand.jhtml")
    Observable<ResponseBody> isDisplayLineBrand(@FieldMap Map<String, String> data);
    ...
    @FormUrlEncoded
    @POST("appInterface/getBrandTypeList.jhtml")
    Observable<ResponseBody> getBrandTypeList(@FieldMap Map<String, String> data);
     ...
     */
    @FormUrlEncoded
    @POST("appInterface/getBrandTypeListBySerarch.jhtml")
    Observable<ResponseBody> getBrandTypeListBySerarch(@FieldMap Map<String, String> data);
     ...
     */
    @FormUrlEncoded
    @POST("appInterface/getHotSearchDataBrand.jhtml")
    Observable<ResponseBody> getHotSearchDataBrand(@FieldMap Map<String, String> data);
     ...
     */
    @FormUrlEncoded
    @POST("appInterface/getLineBrandList.jhtml")
    Observable<ResponseBody> getLineBrandList(@FieldMap Map<String, String> data);
     ...
     */
    @FormUrlEncoded
    @POST("appInterface/getLineBrandByIdList.jhtml")
    Observable<ResponseBody> getLineBrandByIdList(@FieldMap Map<String, String> data);

    @FormUrlEncoded
    @POST("appInterface/getPlusMoneyList.jhtml")
    Observable<ResponseBody> getPlusMoneyList(@FieldMap Map<String, String> data);
